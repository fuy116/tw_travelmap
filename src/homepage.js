            ...
            <svg width="1000" height="1000" fill="#6f9c76" stroke="#ffffff"
                ...
                {<svg baseprofile="tiny" fill="#6f9c76" height="1000" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" version="1.2" viewbox="0 0 1000 1000" width="1000" xmlns="http://www.w3.org/2000/svg" Tooltipdata-tooltip-content="Hello world!">
                    ...
                    <g id="path" >
                        ...
                        <path data-tooltip-id="tooltip" d="M793.1 279.5l1.1 0.7 0.5 0.8 1.2 1.1 2.8 1.1 8.1 1.9-0.2 8.6 0.1 2.2 2.7 2.8-0.3 1.8-1.8 1.3-2.9 1.1-3.7-0.5-7.6-3.1-2.2-1.6-2.6-2.5-2.1-2.5-1.2-2.5-2.1-2.7-0.4-2.1 2.3-1.5 5.2-2.3 3.1-2.1z" id="TWKEE" name="Keelung City">
                        ...
                        <path data-tooltip-id="tooltip" data-tooltip-content="嘉義市" d="M559.2 638.1l-5.3-1.2-5.1-3.3-4.4-1.7-0.6-4.1 2.7-2.9 6.7-1.2 5.7-0.5 4 1.5 3 1.6 1.7 2.9 1.9 4.9-2.2 1.6-3.2 0.4-4.9 2z" id="TWCYI" name="Chiayi City">
