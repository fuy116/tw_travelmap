...
export default function Home() {
    ...
    return (
        ...
        <div>
            <div className="grid grid-cols-2 grid-rows-2 grid-flow-row gap-[5rem]">
                <svg width="1000" height="1000" stroke="#ffffff" onClick={handleClick} className="h-123 flex justify-center items-center row-start-1 row-span-2 "
